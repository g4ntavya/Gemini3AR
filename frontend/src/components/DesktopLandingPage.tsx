                                                ...
                                                >
                                                    {!user && (
                                                        <button
                                                            ...
                                                            className="bg-remindar-button-brown text-remindar-button-text text-[10px] sm:text-sm md:text-base px-4 py-2 md:px-6 md:py-3 hover:brightness-110 transition-all duration-300 relative z-50 cursor-pointer flex items-center gap-2"
